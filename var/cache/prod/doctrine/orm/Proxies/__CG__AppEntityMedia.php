...
class Media extends \App\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Media' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Media' . "\0" . 'altText', '' . "\0" . 'App\\Entity\\Media' . "\0" . 'filename'];
        }
     ...
     * {@inheritDoc}
     */
    public function setAltText(?string $altText): \App\Entity\Media
    {
