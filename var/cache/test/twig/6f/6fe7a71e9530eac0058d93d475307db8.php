...
class __TwigTemplate_1219fbf28df6551a609b74fa97d828fa extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 18
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "_token", [], "any", false, false, false, 18), 'row');
        echo "
\t\t
\t\t<button type=\"submit\" id=\"category_submit\" name=\"category[submit]\" class=\"btn-btn-primary mt-4\">Créer une rubrique
\t\t\tcommission</button>
...
\t</div>
    ...
    {
        return array (  113 => 18,  107 => 15,  102 => 13,  98 => 12,  89 => 5,  79 => 4,  59 => 2,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends \"base.html.twig\" %}
{% block title %}La Buissoniere - Modification des commissions
{% endblock %}
{% block body %}
\t<div class=\"container\">
...
", "pages/category/edit.html.twig", "/Users/ophelie/html/labuissoniere/templates/pages/category/edit.html.twig");
    }
}
