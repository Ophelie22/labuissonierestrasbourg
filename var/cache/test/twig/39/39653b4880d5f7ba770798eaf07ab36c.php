...
class __TwigTemplate_fa524252f9d0dd14a64ba5b375267a2f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "La Buissonière de L'Aar- Modification de l'utilisateur
";
...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 9, $this->source); })()), "flashes", [0 => "warning"], "method", false, false, false, 9));
...
";
    ...
    {
        return array (  113 => 15,  110 => 14,  101 => 11,  98 => 10,  94 => 9,  89 => 6,  79 => 5,  59 => 2,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends 'base.html.twig' %}
{% block title %}La Buissonière de L'Aar- Modification de l'utilisateur
{% endblock %}
...
\t\t</div>
{% endblock %}
", "pages/user/edit.html.twig", "/Users/ophelie/html/labuissoniere/templates/pages/user/edit.html.twig");
    }
}
