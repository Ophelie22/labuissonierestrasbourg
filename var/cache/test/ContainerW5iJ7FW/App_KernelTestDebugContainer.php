...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.article_images' => 'getSmartUniqueNamer_ArticleImagesService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\BeforeEntityPersistedEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\EasyAdminSubscriber'] ?? ($this->privates['App\\EventSubscriber\\EasyAdminSubscriber'] = new \App\EventSubscriber\EasyAdminSubscriber()));
        }, 1 => 'setEntityCreatedAt'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    {
        return $this->privates['App\\Twig\\AppExtension'] = new \App\Twig\AppExtension(($this->services['router'] ?? $this->getRouterService()));
    }
    ...
    {
        return $this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry($this->getEnv('APP_SECRET'), [0 => 'App\\Controller\\Admin\\CategoryCrudController', 1 => 'App\\Controller\\Admin\\ContactCrudController', 2 => 'App\\Controller\\Admin\\MenuCrudController', 3 => 'App\\Controller\\Admin\\UserCrudController']);
    }
    ...
    {
        return $this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Twig\\EasyAdminTwigExtension'] = new \EasyCorp\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension(($this->privates['service_locator_EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator'] ?? $this->getAdminUrlGenerator2Service()), ($this->privates['security.csrf.token_manager'] ?? $this->getSecurity_Csrf_TokenManagerService()));
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MoSQShbv-B', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pz5QGe5Hat', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j4bGm8pJoE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WTnJxQVP-0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5aTHSjSAm0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U0oTs9UJPC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('d1FfVH1JMe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PkNk8GunLW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.webpack_encore.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8xyUvLS0++', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        ]), [0 => 'vich_uploader.listener.clean.article_images', 1 => 'doctrine.orm.messenger.doctrine_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 3 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 4 => 'vich_uploader.listener.remove.article_images', 5 => 'vich_uploader.listener.upload.article_images', 6 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]);
    }
    ...
    protected function getDoctrine_Orm_DefaultConfigurationService()
    {
        ...
        $instance->setEntityListenerResolver(($this->services['doctrine.orm.default_entity_listener_resolver'] ?? $this->getDoctrine_Orm_DefaultEntityListenerResolverService()));
    ...
    {
        return $this->privates['fos_ck_editor.builder.json_builder'] = new \FOS\CKEditorBundle\Builder\JsonBuilder(($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()));
    }
    ...
    {
        $a = ($this->privates['fos_ck_editor.renderer'] ?? $this->getFosCkEditor_RendererService());

        if (isset($this->privates['fos_ck_editor.twig_extension'])) {
            return $this->privates['fos_ck_editor.twig_extension'];
        }

        return $this->privates['fos_ck_editor.twig_extension'] = new \FOS\CKEditorBundle\Twig\CKEditorExtension($a);
    }
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'article_images' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/article'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.article_images',
                        'options' => [
