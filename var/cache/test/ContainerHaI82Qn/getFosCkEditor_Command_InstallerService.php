...
class getFosCkEditor_Command_InstallerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['fos_ck_editor.command.installer'] = $instance = new \FOS\CKEditorBundle\Command\CKEditorInstallerCommand(($container->privates['fos_ck_editor.installer'] ?? ($container->privates['fos_ck_editor.installer'] = new \FOS\CKEditorBundle\Installer\CKEditorInstaller())));
